...
The Lean proofs in both routes were largely generated by [Aristotle](https://aristotle.harmonic.fun)
(Harmonic). They differ in how much human direction and checking went into them:
